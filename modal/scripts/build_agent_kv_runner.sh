...
RUNNER_SOURCE_DIR="${REPO_ROOT}/modal/agent_kv_runner"
...
if [[ ! -x "${CUDA_HOME:-}/bin/nvcc" ]]; then
  echo "[build_agent_kv_runner] ERROR: nvcc not found" >&2
  exit 1
fi
...
echo "[build_agent_kv_runner] Built ${BUILD_DIR}/agent_kv_runner"
