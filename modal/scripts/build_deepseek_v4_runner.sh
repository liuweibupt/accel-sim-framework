...
RUNNER_SOURCE_DIR="${REPO_ROOT}/modal/deepseek_v4_runner"
...
if [[ ! -x "${CUDA_HOME:-}/bin/nvcc" ]]; then
  echo "[build_deepseek_v4_runner] ERROR: nvcc not found" >&2
  exit 1
fi
...
echo "[build_deepseek_v4_runner] Built ${BUILD_DIR}/deepseek_v4_runner"
